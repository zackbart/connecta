...
Connecta began as a radical simplification of [executor](https://github.com/UsefulSoftwareCo/executor).
The table above is the record of that simplification holding.
