...
Source commit: `dbf2b61327abf4da47625253190efd72d4b0ec21`

Runtime: Node 26.5.0; tokenizer `o200k_base`; executor `enabled`

Machine-readable results: `0.9.0-final.json` (run artifact, not committed)
...
- Round trips: 55; summed call latency: 253.6 ms
- Connecta surface: 2,114 definition + 1,146 request + 16,422 response = **19,682 tokens**
