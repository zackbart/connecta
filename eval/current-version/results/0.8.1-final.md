...
Source commit: `e82c5221008b100d33140e3770ddfe521159302a`

Runtime: Node 22.23.1; tokenizer `o200k_base`; executor `enabled`

Machine-readable results: `0.8.1-final.json` (run artifact, not committed)
...
- Round trips: 55; summed call latency: 228.4 ms
- Connecta surface: 2,174 definition + 1,145 request + 16,343 response = **19,662 tokens**
