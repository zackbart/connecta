...
Source commit: `de211a3361cf2cceda0d029948728372b76f670b`

Runtime: Node 22.23.1; tokenizer `o200k_base`; executor `enabled`

Machine-readable results: `0.8.1-step-6-before.json` (run artifact, not committed)
...
- Round trips: 55; summed call latency: 218.9 ms
- Connecta surface: 2,174 definition + 1,143 request + 16,555 response = **19,872 tokens**
