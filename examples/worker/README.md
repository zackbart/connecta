...
color derives from those, so one accent themes the whole page, and a value that
fails its gate falls back to the default with a startup warning naming it. Omit
